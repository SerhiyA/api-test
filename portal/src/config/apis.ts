...
export const APIS: ApiConfig[] = [
  ...
  { id: 'python', name: 'Python / FastAPI', baseUrl: 'http://localhost:3002', enabled: false, color: '#3776ab' },
  { id: 'go', name: 'Go / Gin', baseUrl: 'http://localhost:3003', enabled: false, color: '#00add8' },
